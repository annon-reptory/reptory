...
python word2vec.py ./embedding/corpus.correct ./embedding/vocab.correct ./embedding/embedding.correct

python word2vec.py ./embedding/corpus.buggy ./embedding/vocab.buggy ./embedding/embedding.buggy
