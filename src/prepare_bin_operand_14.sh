...
python3 binoperand-1.py ../create-dataset/binOps_dataset/data-training-binOps.json train
python3 binoperand-1.py ../create-dataset/binOps_dataset/data-test-binOps.json test
...
python3 binoperand-9.py ../create-dataset/binOps_dataset/data-training-binOps.json train
python3 binoperand-9.py ../create-dataset/binOps_dataset/data-test-binOps.json test
