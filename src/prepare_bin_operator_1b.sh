...
python3 binoperator1b.py ../create-dataset/binOps_dataset/data-training-binOps.json train
python3 binoperator1b.py ../create-dataset/binOps_dataset/data-test-binOps.json test
python3 binoperator1b.py ../create-dataset/real-bugs-dataset/operator/fixed/data-training-binOps.json real
