...
python word2vec.py ./embedding/corpus.correct ./embedding/vocab.correct ./embedding/embedding.correct 512 --vocab_size 10000
python word2vec.py ./embedding/corpus.buggy ./embedding/vocab.buggy ./embedding/embedding.buggy 512 --vocab_size 10000
