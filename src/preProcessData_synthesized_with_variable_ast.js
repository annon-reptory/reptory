...
function getArg1(call) {
    ...
    return getIdOrLit(arg1) === "LIT" ?
        "Literal "    + call.synthesizedArgumentTypes[0] + " " + call.arg1 + " " :
        "Identifier " + call.synthesizedArgumentTypes[0] + " " + call.arg1 + " ";
}
...
function getArg2(call) {
    ...
    return getIdOrLit(arg2) === "LIT" ?
        "Literal "    + call.synthesizedArgumentTypes[1] + " " + call.arg2 + " " :
        "Identifier " + call.synthesizedArgumentTypes[1] + " " + call.arg2 + " ";
}
