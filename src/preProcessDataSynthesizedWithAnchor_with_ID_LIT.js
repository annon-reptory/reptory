...
fs.createReadStream('./dataset/data-test-calls.json')
    ...
    .pipe(es.mapSync(function (call) {
        ...
        const correctCall = baseAndCallee
            ...
            + "("
            + " "
            + "arg0 " + getIdOrLit(currentCall.arguments[0])
            + " "
            + call.synthesizedArgumentTypes[0]
            + " "
            + ","
            + " "
            + "arg1 " + getIdOrLit(currentCall.arguments[1])
            + " "
        ...
        const buggyCall = baseAndCallee
            ...
            + "("
            + " "
            + "arg0 " + getIdOrLit(currentCall.arguments[1])
            + " "
            + call.synthesizedArgumentTypes[1]
            + ","
            + " "
            + "arg1"  + getIdOrLit(currentCall.arguments[0])
            + " "
            + call.synthesizedArgumentTypes[0]
            + " "
            + ")";
