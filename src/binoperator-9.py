...
def find_datapoints(data_path, mode):
    ...
    for binop in all_binops:
        ...
        single_binop = {
            ...
            "leftPrefix" : binop["original"]["left"].strip().split(":")[0],
            "rightPrefix": binop["original"]["right"].strip().split(":")[0],
    ...
    if (mode == "train"):
        ...
        for binop in binops:
            ...
            if binop['rightPrefix'] == "ID":
                ...
                rightPref = "Literal"
            correct = "Program " + "ExpressionStatement " + "BinaryExpression operator " + binop['op'] + " left " + leftPref + " " + binop['left'] + " right " + rightPref + " " + binop['right'];
            ...
            buggy = "Program " + "ExpressionStatement " + "BinaryExpression operator " + wrong_op + " left " + leftPref + " " + binop['left'] + " right " + rightPref + " " + binop['right'];
