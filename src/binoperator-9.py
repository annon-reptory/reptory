    ...
    if mode == 'train':
        ...
        for binop in binops:
            ...
            if binop['rightPrefix'] == 'ID':
                ...
                rightPref = 'Literal'
            correct = 'Program ' + 'ExpressionStatement ' \
                + 'BinaryExpression operator ' + binop['op'] + ' left ' \
                + leftPref + ' ' + binop['left'] + ' right ' \
                + rightPref + ' ' + binop['right']
            ...
            buggy = 'Program ' + 'ExpressionStatement ' \
                + 'BinaryExpression operator ' + wrong_op + ' left ' \
                + leftPref + ' ' + binop['left'] + ' right ' \
                + rightPref + ' ' + binop['right']
