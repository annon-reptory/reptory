...
def find_datapoints(data_path, mode):
    ...
    if (mode == "train"):
        ...
        for binop in binops:
            correct = binop['leftPrefix'] + " " + binop['leftType'] + " " + binop['left'] + " " + binop['op'] + " " + binop['rightPrefix'] + " " + binop['rightType'] + " " + binop['right'];
            ...
            buggy = binop['leftPrefix'] + " " + binop['leftType'] + " " + binop['left'] + " " + wrong_op + " " + binop['rightPrefix'] + " " + binop['rightType'] + " " + binop['right'];
