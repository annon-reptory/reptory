...
python3 binoperator_abstraction.py ../create-dataset/binOps_dataset/data-training-binOps.json ../create-dataset/binOps_dataset/data-test-binOps.json ../create-dataset/real-bugs-dataset/operator/fixed/data-training-binOps.json ../create-dataset/keywords.csv 300
