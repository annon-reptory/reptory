...
python3 calls_tufano_abstraction_to_code_simplification_signatures_with_position_anchor.py ./dataset/data-training-calls.json ./dataset/data-test-calls.json ./dataset/real-bugs-calls.json ../create-dataset/keywords.csv 300
