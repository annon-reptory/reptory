...
def find_datapoints(data_path, mode):
    ...
    if (mode == "train"):
        ...
        for binop in binops:
            correct = binop['leftPrefix'] + " " + binop['leftType'] + " " + binop['op'] + " " + binop['rightPrefix'] + " " + binop['rightType'];
            ...
            buggy = binop['leftPrefix'] + " " + binop['leftType'] + " " + wrong_op + " " + binop['rightPrefix'] + " " + binop['rightType'];
