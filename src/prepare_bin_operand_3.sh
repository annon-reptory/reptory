...
python3 binoperand-3.py ../create-dataset/binOps_dataset/data-training-binOps.json train
python3 binoperand-3.py ../create-dataset/binOps_dataset/data-test-binOps.json test
python3 binoperand-3.py ../create-dataset/real-bugs-dataset/operands/fixed/data-training-binOps.json real
