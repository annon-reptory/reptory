...
python word2vec-skipgrams.py ./embedding/corpus.correct ./embedding/vocab.correct ./embedding/embedding.correct 512
python word2vec-skipgrams.py ./embedding/corpus.buggy ./embedding/vocab.buggy ./embedding/embedding.buggy 512
