...
python3 calls_abstraction.py ./dataset/data-training-calls.json ./dataset/data-test-calls.json ./dataset/real-bugs-calls.json ../create-dataset/keywords.csv 300
...
sh get-embedding-fasttext-final.sh
