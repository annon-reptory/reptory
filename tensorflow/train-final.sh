...
cd data
python calculate_accuracy_and_rank.py test.correct test.buggy model.output patches-test-data.patch 2>&1 | tee accuracy-calculation-test-data.log
...
cd data
python calculate_accuracy_and_rank.py realbugs.correct realbugs.buggy realbugs.model.output patches-real-bugs.patch | tee accuracy-calculation-real-bugs.log
